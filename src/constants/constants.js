...
export const ROUTES = {
    ...
    SCREENING: '/application/:application_id/screening',
    LEASE_TERMS: '/application/:application_id/lease-terms',
    ...
    FAQ: '/faq',
    UNIT_UNAVAILABLE: '/application/:application_id/unit-unavailable',
    UNAUTHENTICATED_UNIT_UNAVAILABLE: '/unauth-unit-unavailable',
    GUARANTOR_REQUESTED: '/application/:application_id/guarantor_request',
    PAYMENT_DETAILS: '/application/:application_id/payment-details',

    // Application routes
    APP_COMPLETE: '/application/:application_id/application-complete',
    APP_APPROVED: '/application/:application_id/application-approved',
    APP_CANCELLED: '/application/:application_id/application-cancelled',
    APP_DENIED: '/application/:application_id/application-denied',

    // Lease routes
    LEASE_SIGNED: '/application/:application_id/lease-signed',
    LEASE_EXECUTED: '/application/:application_id/lease-executed',
    LEASE_VOIDED: '/application/:application_id/lease-voided',
    ...
    RENTAL_PROFILE: '/application/:application_id/rental-profile',
    PROFILE_OPTIONS: '/application/:application_id/rental-profile/options',
    GUARANTOR: '/application/:application_id/rental-profile/invite-guarantor',
    PARKING: '/application/:application_id/rental-profile/parking',
    PETS: '/application/:application_id/rental-profile/pets',
    STORAGE: '/application/:application_id/rental-profile/storage',
    WINE_COOLER: '/application/:application_id/rental-profile/wine-cooler',
    CO_APPLICANTS: '/application/:application_id/rental-profile/invite-roommates',
    EDIT_DEPENDANT: '/application/:application_id/rental-profile/dependent/:id/edit',
    ...
    MANUAL_INCOME_ENTRY_ADD_INCOME: '/application/:application_id/income-employment/manual/add-income',
...
export const ROLE_PRIMARY_APPLICANT_VALUE = 10;
export const ROLE_CO_APPLICANT_VALUE = 20;
export const ROLE_GUARANTOR_VALUE = 30;
export const ROLE_OCCUPANT_VALUE = 40;

export const APPLICANT_ROLE_VALUES = {
    ROLE_PRIMARY_APPLICANT: ROLE_PRIMARY_APPLICANT_VALUE,
    ROLE_CO_APPLICANT: ROLE_CO_APPLICANT_VALUE,
    ROLE_GUARANTOR: ROLE_GUARANTOR_VALUE,
    ROLE_OCCUPANT: ROLE_OCCUPANT_VALUE,
};

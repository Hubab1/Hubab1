...
import { MILESTONE_LEASE_SENT, ROLE_OCCUPANT } from 'constants/constants';
import { ApplicationApprovedView } from './ApplicationApprovedView';
...
it('displays some legal words about the lease', () => {
    ...
    const wrapper = shallow(<ApplicationApprovedView {...props} />);

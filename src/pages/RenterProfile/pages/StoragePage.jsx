...
import { ROUTES, RENTER_PROFILE_TYPE_STORAGE, RENTER_PROFILE_TYPE_CO_APPLICANTS } from 'constants/constants';
...
export const StoragePage = (props) => {
    ...
    const url = generatePath(`${ROUTES.PROFILE_OPTIONS}#${RENTER_PROFILE_TYPE_STORAGE}`, {

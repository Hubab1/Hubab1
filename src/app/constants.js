...
export const MILESTONE_INCOME_COMPLETED = 10020;
export const MILESTONE_HOLDING_DEPOSIT_SIGNED = 10030;
export const MILESTONE_RENTAL_PROFILE_COMPLETED = 10050;
export const MILESTONE_APPLICANT_SUBMITTED = 10060;
export const MILESTONE_FINANCIAL_STREAM_DOCUMENTS_REQUESTED = 10080;
export const MILESTONE_APPLICANT_SIGNED_LEASE = 10090;
// Application Milestones
export const MILESTONE_APPLICATION_FEE_COMPLETED = 20010;
export const MILESTONE_REQUEST_GUARANTOR = 20030;
export const MILESTONE_LEASE_SENT = 20040;
export const MILESTONE_LEASE_VOIDED = 20050;

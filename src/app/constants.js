...
export const EVENT_HOLDING_DEPOSIT_COUNTERSIGNED = 320;
export const EVENT_HOLDING_DEPOSIT_SIGNED = 310;
...
export const APPLICATION_EVENTS = {
    ...
    EVENT_HOLDING_DEPOSIT_COUNTERSIGNED, EVENT_HOLDING_DEPOSIT_SIGNED
};

...
export const MILESTONE_REQUEST_GUARANTOR = 350;
...
export const MILESTONE_FINANCIAL_STREAM_MORE_DOCUMENTS_REQUESTED = 355;
...
export const APPLICATION_EVENTS = {
    EVENT_APPLICANT_REGISTERED, EVENT_LEASE_TERMS_COMPLETED, EVENT_RENTAL_OPTIONS_SELECTED,
    EVENT_RENTAL_OPTIONS_NOT_SELECTED, EVENT_RENTAL_OPTIONS_COAPPLICANT_INVITED, EVENT_RENTAL_OPTIONS_GUARANTOR_INVITED,
    EVENT_RENTAL_OPTIONS_PET_ADDED, EVENT_INCOME_REPORTS_GENERATED, EVENT_APPLICATION_FEE_PAID,
    EVENT_SCREENING_COMPLETED, MILESTONE_APPLICANT_SIGNED_LEASE, MILESTONE_LEASE_VOIDED, MILESTONE_INCOME_COMPLETED,
    MILESTONE_HOLDING_DEPOSIT_SIGNED, MILESTONE_REQUEST_GUARANTOR
};

export const APPLICATION_STATUSES = {
    APPLICATION_STATUS_APPROVED, APPLICATION_STATUS_CONDITIONALLY_APPROVED, APPLICATION_STATUS_COMPLETED,
    APPLICATION_STATUS_DENIED, APPLICATION_STATUS_CANCELED,
};

...
//     });
//
//     it.only('should verify that the lease start date is on or after today', async () => {
//         const data = getValidData();
//         data.unit = {
//             id: 123,
//             unit_number: '15',
...
//     });
//
//     it.skip('should verify that the selected lease start date is on or after unit available date', async () => {
//         const data = getValidData();
//

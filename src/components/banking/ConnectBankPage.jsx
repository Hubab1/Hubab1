...
import { H1, H3, P, Bold } from 'assets/styles'; // add back linkRoot when we add LINK back
...
export class ConnectBankPage extends React.Component {
    ...
    render () {
        ...
        return (
            <Fragment>
                <H1>Verify Your Income & Assets Instantly</H1>
                ...
                {/* add this back when we add manual income entry pages
